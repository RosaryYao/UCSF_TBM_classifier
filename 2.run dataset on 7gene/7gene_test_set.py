...
for i in np.arange(BS):
    ...
    ####use 7 gene signature####
    
    seven_gene = ['ENSG00000154451', 'ENSG00000112096', 'ENSG00000087086', 'ENSG00000100906', 'ENSG00000156508', 'ENSG00000205542', 'ENSG00000075624']
    
    training_x1 = train_norm[train_norm.index.isin(seven_gene)].T
    training_x2 = training_x1.merge(dfb, how='left', left_index = True, right_index = True)
    
    training = training_x2.drop('key',axis=1)
    Y = training_x2.loc[:,'key']
    
    test = test_norm[test_norm.index.isin(seven_gene)].T
