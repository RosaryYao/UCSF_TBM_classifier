...
for i in np.arange(BS):
    ...
    ####use 4 gene signature####
    
    four_gene = ['ENSG00000154451', 'ENSG00000112096', 'ENSG00000087086', 'ENSG00000100906']
    
    training_x1 = train_norm[train_norm.index.isin(four_gene)].T
    ...
    test = test_norm[test_norm.index.isin(four_gene)].T
